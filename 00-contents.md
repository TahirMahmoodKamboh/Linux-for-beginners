# 📘 Linux for Absolute Beginners – Contents

Welcome to the **Linux for Absolute Beginners** course.  
Follow the lessons **in order**. Each file builds on the previous one.
...
- 📄 [01 – What is Linux?](01-what-is-linux.md)
- 📄 [02 – Linux Distributions](02-linux-distributions.md)
- 📄 [03 – Installing Linux](03-installing-linux.md)
- 📄 [04 – Linux Desktop Tour](04-linux-desktop-tour.md)

---

## 🟡 Terminal & File Basics

- 📄 [05 – Terminal Basics](05-terminal-basics.md)
- 📄 [06 – Files and Directories](06-files-and-directories.md)
...
## 🟣 System Internals & Best Practices
...
✅ **Tip:**  
If you are new to Linux, start from **00** and move step by step.  
